...
online version: https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/Set-RoutingTransport.md
schema: 2.0.0
---

# Set-MHRoutingTransport
...
```
Set-MHRoutingTransport [-Id] <Int32[]> [[-Destination] <String>] [[-Hostname] <String>] [[-Port] <Int32>]
 [[-Username] <String>] [[-Password] <SecureString>] [-IsMxBased] [-Enable]
...
[https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/Set-RoutingTransport.md](https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/Set-RoutingTransport.md)

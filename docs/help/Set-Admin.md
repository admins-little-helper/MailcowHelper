...
online version: https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/Set-Admin.md
schema: 2.0.0
---
...
```
Set-MHAdmin [-Username] <String> [[-Password] <SecureString>] [-Enable] [-ProgressAction <ActionPreference>]
...
[https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/Set-Admin.md](https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/Set-Admin.md)

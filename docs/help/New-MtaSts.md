...
online version: https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-MtaSts.md
schema: 2.0.0
---
...
```
New-MHMtaSts [-Domain] <String[]> [[-Version] <String>] [[-Mode] <String>] [-MxServer] <String[]>
...
[https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-MtaSts.md](https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-MtaSts.md)

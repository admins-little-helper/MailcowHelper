...
online version: https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-SyncJob.md
schema: 2.0.0
---
...
```
New-MHSyncJob [-Identity] <MailAddress> [-Hostname] <String> [[-Port] <Int32>] [-Username] <MailAddress>
...
The login name for the remote mailbox is set to "user@mail.anotherexample.com".
The password will be requested to enter interactively.
...
[https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-SyncJob.md](https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-SyncJob.md)

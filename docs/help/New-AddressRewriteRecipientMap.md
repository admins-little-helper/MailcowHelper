...
online version: https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-AddressRewriteRecipientMap.md
schema: 2.0.0
---

# New-MHAddressRewriteRecipientMap
...
```
New-MHAddressRewriteRecipientMap [-OriginalDomainOrMailAddress] <String[]>
...
[https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-AddressRewriteRecipientMap.md](https://github.com/admins-little-helper/MailcowHelper/blob/main/docs/help/New-AddressRewriteRecipientMap.md)

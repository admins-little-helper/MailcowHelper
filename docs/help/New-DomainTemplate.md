...
```
New-MHDomainTemplate [-Name] <String> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### IndividualSettings
```
New-MHDomainTemplate [-Name] <String> [[-MaxNumberOfAliasesForDomain] <Int32>]
